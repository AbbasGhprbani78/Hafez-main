...
export default function AccountingItem() {
  const { id } = useParams();
        ...
        >
          ...
          <div className={styles.wrapper_info}>
            ...
            <Grid container className={`${styles.content} `}>
              ...
              >
                <span className={"key_item"}>مدل :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={styles.item_content}
              >
                <span className={"key_item"}>پلاک :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={styles.item_content}
              >
                <span className={"key_item"}>شماره شاسی :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={styles.item_content}
              >
                <span className={"key_item"}>کیلومتر :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={styles.item_content}
              >
                <span className={"key_item"}>رنگ :</span>
                <span className={"value_item"}>
          ...
          <div className={styles.wrapper_info}>
            ...
            <Grid container className={`${styles.content} `}>
              ...
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>تاریخ پذیرش :</span>
                <span className={"value_item"}>
                  {toFarsiNumber(
              ...
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>شماره فاکتور :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>تاریخ فاکتور :</span>
                <span className={"value_item"}>
                  {toFarsiNumber(
                    convertGregorianToPersian(
              ...
              {/* <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>زمان تخمینی:</span>
                <span className={"value_item"}>1403/12/19</span>
              </Grid>
              <Grid
                size={{ xs: 12, md: 6, lg: 4 }}
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>هزینه تخمینی :</span>
                <span className={"value_item"}>
            ...
            {/* <Grid container className={`${styles.content} `}>
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>شماره هرم :</span>
                <span className={"value_item"}>
                  {toFarsiNumber(20000)}
                </span>
              </Grid>
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>توضیحات :</span>
                <span className={"value_item"}>
          ...
          <div className={styles.wrapper_info}>
            ...
            <Grid container className={`${styles.content} `}>
              ...
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>کد ملی :</span>
                <span className={"value_item"}>
              ...
              <Grid
                ...
                className={`${styles.item_content}`}
              >
                <span className={"key_item"}>تلفن همراه :</span>
                <span className={"value_item"}>
          ...
          >
            <Grid size={{ xs: 12, md: 7 }} className={styles.payment_method}>
              <div className={styles.wrap_accardions}>
                <Accardion
                  title={"انتخاب تخفیف"}
                  content="امکان ثبت و اعمال تخفیف در حال حاضر فعال نیست"
                />
                <Accardion
                  title={"پرداخت چک"}
                  content="ثبت و مدیریت پرداخت‌های چکی در حال حاضر در دسترس نیست"
                />
                <Accardion
                  title={"پرداخت نقدی"}
                  content="امکان ثبت پرداخت نقدی فعلاً در سیستم فعال نیست"
                />
              </div>
